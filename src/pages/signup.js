...
export async function renderSignup(container, params) {
  if (auth.isLoggedIn()) {
  ...
  container.innerHTML = `
    <div class="auth-page-fullscreen">
      <!-- Background image -->
      <div class="auth-fullscreen-bg auth-signup-bg"></div>
      ...
      <div class="auth-center-col">
        ...
        <div class="auth-card">
          ...
          <p class="auth-card-subtitle">Join thousands of pet parents who trust Pawfect for premium grooming.</p>
          ...
          <form class="auth-form" id="signup-form">
            ...
            <div class="auth-field-row">
              <div class="auth-field">
                ...
                <div class="auth-input-wrap">
                  ...
                  <input type="text" class="auth-input" placeholder="Rahul Sharma" id="fullName" autocomplete="name" required>
                </div>
              </div>
              <div class="auth-field">
                ...
                <div class="auth-input-wrap">
                  ...
                  <input type="tel" class="auth-input" placeholder="+91 98765 43210" id="phone" autocomplete="tel" required>
                </div>
              </div>
            </div>
            ...
            <div class="auth-field">
              ...
              <div class="auth-input-wrap">
                ...
                <input type="email" class="auth-input" placeholder="rahul@example.com" id="email" autocomplete="email" required>
              </div>
            </div>
            ...
            <div class="auth-field">
              ...
              <div class="auth-input-wrap">
                ...
                <input type="password" class="auth-input" placeholder="••••••••" id="password" autocomplete="new-password" required>
              </div>
            </div>
            ...
            <div class="auth-options">
              <label class="auth-checkbox-label">
                ...
                <span>I agree to the <a href="#" class="auth-link">Terms &amp; Privacy</a></span>
              </label>
            </div>

            <!-- Submit -->
            <button type="submit" class="btn btn-primary auth-submit-btn" id="btn-signup-submit">
              Create Account 🐾
            </button>
            ...
            <p class="auth-switch-text">
              Already have an account? <a href="/login" class="auth-link" data-link>Sign In</a>
            </p>
          </form>
        </div>
      </div>
  ...
  setTimeout(() => {
    ...
    form?.addEventListener('submit', (e) => {
      ...
      const btn = container.querySelector('#btn-signup-submit');
      btn.innerHTML = `<i data-lucide="loader" class="spin"></i> Creating Account...`;
      if (window.lucide) lucide.createIcons();
      setTimeout(() => {
        try {
          const user = auth.signup(fullName, email, phone);
          showToast(`Account created! Welcome, ${user.name}! 🎉🐾`, 'success');
          setTimeout(() => { window.location.href = '/dashboard'; }, 600);
        } catch (err) {
          showToast('Failed to register. Please check your info.', 'error');
    ...
    googleBtn?.addEventListener('click', () => {
      ...
      setTimeout(() => {
        auth.signup('Google User', 'googleUser@example.com', '+919999999999');
